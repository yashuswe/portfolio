...
import { Code2, Server, Wrench, Shield, Sparkles, Zap } from "lucide-react";
...
function SkillCard({
  ...
  return (
    ...
    >
      <Card
        className={`h-full border-2 ${category.borderColor} hover:border-opacity-60 transition-all duration-300 group relative overflow-hidden`}
      >
